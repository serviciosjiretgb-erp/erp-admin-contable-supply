...
export default function App() {
  ...
  // Estado compartido del módulo Reportes Financieros (persiste mientras no se desmonta App)
  ...
  return (
    <ErrorBoundary>
      ...
      {view === 'reportes_financieros' && <ReportesFinancierosApp onBack={() => go('cont_dash')} />}
